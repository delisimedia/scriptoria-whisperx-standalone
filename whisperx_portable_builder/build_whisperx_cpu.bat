@echo off
REM ============================================================================
REM WhisperX Portable Environment Builder - CPU Version
REM ============================================================================
REM This script creates a self-contained WhisperX environment with CPU support
REM for users without NVIDIA GPUs or with AMD/Intel GPUs.
REM
REM Requirements:
REM   - Windows 10/11
...
REM
REM Output:
REM   - whisperx_portable_win64_cpu_v3.4.2.zip (~800 MB)
REM ============================================================================

setlocal enabledelayedexpansion

echo ============================================================================
echo WhisperX Portable Environment Builder - CPU Version
echo ============================================================================
echo.
...
echo   PyTorch: %PYTORCH_VERSION% (CPU-only)
...
"%ENV_DIR%\Scripts\python.exe" -m pip install torch==%PYTORCH_VERSION% torchaudio==%TORCHAUDIO_VERSION% --index-url https://download.pytorch.org/whl/cpu
...
"%ENV_DIR%\Scripts\python.exe" -m pip install -r "%~dp0requirements_cpu.txt"
...
echo.
echo Testing PyTorch CPU...
"%ENV_DIR%\Scripts\python.exe" -c "import torch; print(f'PyTorch {torch.__version__}'); print(f'CPU-only version: {not torch.cuda.is_available()}')"
...
set OUTPUT_FILE=%OUTPUT_DIR%\whisperx_portable_win64_cpu_%PACKAGE_VERSION%.zip
